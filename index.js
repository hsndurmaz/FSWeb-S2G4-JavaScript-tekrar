...
console.log("KareninAlani", KareninAlani);
...
console.log("enkucuk", enkucuk, "enbuyuk", enbuyuk);
// 3b çözümü:
...
console.log("ucetambolunenlerintoplami", ucebolunenlerintoplami);
...
sayilarTekrarObj = sayilar.reduce((obj, sayi) => {
  return { ...obj, [sayi]: obj[sayi] ? obj[sayi] + 1 : 1 };
}, {});
